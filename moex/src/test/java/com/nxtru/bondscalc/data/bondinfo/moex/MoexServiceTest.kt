...
//    }
    ...
    fun extreactBondInfoTest() {
        assertEquals(
            BondInfo(secId = "RU000A104ZQ9", ticker="ВТБ Б1-311", isin="RU000A104ZQ9", parValue="1000", coupon="7.500", maturityDate="27.07.2023"),
            extreactBondInfo(readLines("/extractTickets/RU000A104ZQ9.csv"))
        )
        assertEquals(
            BondInfo(secId = "RU000A0ZYAP9", ticker="ГТЛК 1P-06", isin="RU000A0ZYAP9", parValue="755.55", coupon="9.500", maturityDate="01.09.2032"),
            extreactBondInfo(readLines("/extractTickets/RU000A0ZYAP9.csv"))
        )
        assertEquals(
            BondInfo(secId = "SU26229RMFS3", ticker="ОФЗ 26229", isin="RU000A100EG3", parValue="1000", coupon="7.150", maturityDate="12.11.2025"),
            extreactBondInfo(readLines("/extractTickets/SU26229RMFS3.csv"))
        )
        assertEquals(
            null,
